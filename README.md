...
<p align="center">
  <img src="https://raw.githubusercontent.com/darrenak403/beyond8-client/main/public/icon-logo.png" alt="Beyond8 Logo" width="300" />
</p>
...
- [👥 Đội ngũ Frontend](#-đội-ngũ-frontend)
- [✨ Tính năng cốt lõi](#-tính-năng-cốt-lõi)
- [🛠️ Tech Stack](#️-tech-stack)
- [⚙️ Yêu cầu trước khi chạy](#️-yêu-cầu-trước-khi-chạy)
- [🚀 Cài đặt](#-cài-đặt)
- [🐳 Chạy bằng Docker](#-chạy-bằng-docker)
- [📁 Cấu trúc dự án](#-cấu-trúc-dự-án)
- [🔌 Cách fetch API & Custom Hooks](#-cách-fetch-api--custom-hooks)
