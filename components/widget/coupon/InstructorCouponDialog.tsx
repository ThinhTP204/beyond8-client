...
export function InstructorCouponDialog({
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            ...
            if (errorMessage.includes("số dư") || errorMessage.includes("xu") || errorMessage.includes("balance") || errorMessage.includes("không đủ")) {
                toast.error((error as Error)?.message || "Số dư ví không đủ để tạo mã giảm giá. Vui lòng nạp thêm tiền.");
