        ...
        >
            ...
            <div className="relative w-80 shrink-0 aspect-[16/9] rounded-xl overflow-hidden bg-gradient-to-br from-slate-100 to-slate-50 shadow-md">
                ...
                <div className="absolute bottom-2.5 right-2.5">
                    <Badge variant="secondary" className="backdrop-blur-lg bg-black/70 text-white border-0 text-xs h-6 px-2.5 font-medium shadow-lg">
                    ...
                    <div className="space-y-2.5">
                        ...
                        <div className="space-y-1.5 pt-1">
                            ...
                            <p className="text-sm text-slate-500 flex items-center gap-1.5">
                                Người dạy: <span className="font-semibold text-slate-700 bg-slate-50 px-2 py-0.5 rounded">{course.instructorName}</span>
                            </p>
                        </div>
                    </div>
                </div>
